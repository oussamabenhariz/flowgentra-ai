...
- Overview of FlowgentraAI concepts
...
- **Why:** You MUST create a `config.yaml` file to use FlowgentraAI
...
### For Handler Registration (IMPORTANT!)

**[macros/README.md](macros/README.md)** 🎯 *Handler Registration*
- How to use `#[register_handler]` macro
- Automatic handler discovery
- Handler requirements and best practices
- Module organization patterns
- Common patterns and troubleshooting

This covers the critical topic of making your handlers discoverable by FlowgentraAI agents!

**Quick reference:**
```rust
#[register_handler]  // ← Add this to your handler functions
...
### For Graph Building and Routing

**[graph/README.md](graph/README.md)** 🔀 *Custom Workflows*
- Build custom graphs with GraphBuilder
- Conditional routing based on state
- Real-world routing patterns
- Best practices and debugging

Use this when you need to build sophisticated workflows with branching and conditional logic!
...
→ [handlers/README.md](handlers/README.md) + [macros/README.md](macros/README.md)

#### Register Handlers for Auto-Discovery
...
```rust
#[register_handler]  // ← Macro for auto-discovery!
...
**Important:** Use the `#[register_handler]` macro so your handler can be automatically discovered from the config file.

See [handlers/README.md](handlers/README.md) for patterns and [macros/README.md](macros/README.md) for the `#[register_handler]` macro reference.
...
| [handlers/README.md](handlers/README.md) | Handler patterns | Developers | 15 min |
| [macros/README.md](macros/README.md) | `#[register_handler]` macro | Developers | 15 min |
| [graph/README.md](graph/README.md) | Graph building & routing | Developers | 20 min |
| [DEVELOPER_GUIDE.md](DEVELOPER_GUIDE.md) | Advanced patterns | Advanced developers | 1 hour |
