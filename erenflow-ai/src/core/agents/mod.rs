...
///
/// Similar to LangChain, ErenFlowAI provides factory builders for common agent patterns.
/// Users can initialize and use agents directly without building complex graph configurations.
///
/// # Examples
///
/// ```ignore
/// use erenflow_ai::core::agents::{AgentBuilder, AgentType, ToolSpec};
///
...
pub trait Agent: Send + Sync {
    ...
    fn process(&self, input: &str, state: &State) -> Result<String, ErenFlowError>;
